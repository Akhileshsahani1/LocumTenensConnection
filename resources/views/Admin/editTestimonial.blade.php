...
<div class="admin_dashboard_inner px-5 py-5">
    <div class="row mb-5 mx-0">
        <div class="col-lg-12 commn_title_header px-0">
            <p class="mb-3">Edit Testimonial</p>
        </div>
    </div>
    <div class="row mx-0">
        <div class="col-lg-3 px-0">
            ...
            @endif
            <form class="login_form" action="{{ route('updateTestimonial', $testim->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="mb-4 form_filed">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control" name="name" id="name" value="{{$testim->name}}" placeholder="Enter Name" maxlength="20" />
                    @if($errors->has('name'))
                ...
                <div class="mb-4 form_filed">
                    ...
                    <input type="text" class="form-control" name="designation" value="{{$testim->designation}}" placeholder="Enter Designation" maxlength="50" />
                ...
                <div class="mb-4 form_filed">
                    ...
                    <textarea class="form-control" name="description"  id="description" placeholder="Enter Description" maxlength="300">{{$testim->description}}</textarea>
                ...
                <div class="mb-4 form_filed">
                    ...
                    @if(!empty($testim->testimonial_image))
                    <img src="{{asset('Admin/testimonial/'.$testim->testimonial_image)}}" class="mt-4" width="100" height="100"/>
                    @endif
