...
<div class="admin_dashboard_inner px-5 py-5">
   <div class="row mb-5 mx-0">
      <div class="col-lg-12 commn_title_header px-0">
         <p class="mb-3">Edit Our Mission</p>
      </div>
   </div>
   <div class="row mx-0">
      <div class="col-lg-8 px-0">
         ...
         @endif
         <form class="login_form" action="{{route('updateMission', $displaymission_data->id)}}" method="POST" enctype="multipart/form-data" onsubmit="return validation()">
            @csrf
            <div class="row">
               <div class="col-lg-12">
                  <div class="mb-4 form_filed">
                     <label for="logo" class="form-label">Our Mission Content</label>
                     <textarea id="our_mission_contents" class="form-control" rows="3" name="our_mission_contents" maxlength="500">@if (!empty($displaymission_data->our_mission_contents)){{$displaymission_data->our_mission_contents}}@endif</textarea>
               ...
               <div class="col-lg-6">
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter First Paragraph of Detanal Practice" @if(!empty($displaymission_data->dentalpractice_para_first)) value="{{$displaymission_data->dentalpractice_para_first}}" @endif maxlength="100"/>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Search Content" @if(!empty($displaymission_data->dentalpractice_search)) value="{{$displaymission_data->dentalpractice_search}}" @endif maxlength="100"/>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     <textarea id="dentalpractice_schedule" class="form-control" name="dentalpractice_schedule" maxlength="130">@if(!empty($displaymission_data->dentalpractice_schedule)){{$displaymission_data->dentalpractice_schedule}}@endif</textarea>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter book Content" @if(!empty($displaymission_data->dentalpractice_book)) value="{{$displaymission_data->dentalpractice_book}}" @endif maxlength="100" />
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Review Content" @if(!empty($displaymission_data->dentalpractice_review)) value="{{$displaymission_data->dentalpractice_review}}" @endif maxlength="100"/>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Review Conent Detanal Professional" @if(!empty($displaymission_data->dentalprofessional_review)) value="{{$displaymission_data->dentalprofessional_review}}" @endif maxlength="100"/>
               ...
               <div class="col-lg-6">
                  <div class="mb-4 form_filed">
                     ...
                     <textarea id="dentalprofessional_para_first" class="form-control" name="dentalprofessional_para_first" 
                        placeholder="Enter First Paragraph of Detanal Professional" maxlength="100">@if(!empty($displaymission_data->dentalprofessional_para_first)) {{$displaymission_data->dentalprofessional_para_first}}@endif</textarea>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Profile Conent Detanal Professional"  @if(!empty($displaymission_data->dentalprofessional_profile)) value="{{$displaymission_data->dentalprofessional_profile}}" @endif maxlength="100"/>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Profile Conent Detanal Professional"  @if(!empty($displaymission_data->dentalprofessional_schedule)) value="{{$displaymission_data->dentalprofessional_schedule}}" @endif maxlength="100"/>
                  ...
                  <div class="mb-4 form_filed">
                     ...
                     placeholder="Enter Accept Conent Detanal Professional" @if(!empty($displaymission_data->dentalprofessional_accept)) value="{{$displaymission_data->dentalprofessional_accept}}" @endif maxlength="100"/>
                     <span id="dentalprofessional_accept_error" class="text-danger"></span>
                  </div>
                  <div class="mb-4 form_filed">
                     <label for="dentalprofessional_getpaid" class="form-label">Dental Professional Get Paid</label>
                     <input type="text" class="form-control" name="dentalprofessional_getpaid" id="dentalprofessional_getpaid"
                     placeholder="Enter Get Paid Conent Detanal Professional" @if(!empty($displaymission_data->dentalprofessional_getpaid)) value="{{$displaymission_data->dentalprofessional_getpaid}}" @endif maxlength="100"/>
                     <span id="dentalprofessional_getpaid_error" class="text-danger"></span>
                  </div>
                  <button type="submit" class="btn btn_commn_sm my-4">Update Our Mission</button>
               </div>
            </div>
         </form>
      </div>
