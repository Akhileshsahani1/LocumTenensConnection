   ...
   <div class="container-fluid chat-panel px-5 mob-p-0">
      <div class="heading ps-5 pe-5 me-xxl-5 ">
         <div class="d-flex justify-content-between align-items-center border-bottom pb-2">
            <h3 class="font-20 fw-bold">Chat with Practice</h3>
         </div>
      </div>
...
function send_chat_message(to_user_id)
{
	...
	// 	console.log("555555555555555",fileInput[i])
	
	// 	formData.append('files', fileInput[i]);
	// 	console.log(formData,"llllllllllllllllllllllllllll")
...
{ 
	...
	let tr=document.querySelector('#messagess').value;
		...
		console.log(data,"LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
